...
void OtaController::checkUpdate() {
    ...
    // Disabled to prevent accidental update
    // TODO: NTP Time Client for Cert validation
        ...
        for(;;) { // shit code: build thread
            ...
            switch(otastatus) {
                ...
                case HTTPS_OTA_SUCCESS:
                    Serial.println("OTA did complete. Reboot device to apply.");
                    break;
                case HTTPS_OTA_FAIL:
